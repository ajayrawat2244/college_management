"""
Django settings for sms_management project.
...
SECRET_KEY = 'django-insecure-cp&^7am@q31_@4_zw&q#fx4mwjj5h-0lskv@w2go0z_dlw0zku'
...
WSGI_APPLICATION = 'sms_management.wsgi.application'
